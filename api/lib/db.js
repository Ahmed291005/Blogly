...
try {
  ...
  const connectionString = process.env.DATABASE_URL || 'postgresql://neondb_owner:npg_1v9HNbSwJdLE@ep-aged-dew-abcwmtyn-pooler.eu-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require';
  ...
  const { Pool } = require('pg');
  pool = new Pool({
    connectionString: process.env.DATABASE_URL || 'postgresql://neondb_owner:npg_1v9HNbSwJdLE@ep-aged-dew-abcwmtyn-pooler.eu-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require',
    ssl: {
      rejectUnauthorized: false
    },
    max: 3,
