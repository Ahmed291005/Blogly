...
const Admin = () => {
  ...
  const tabs = [
    { id: 'overview', label: 'Overview', icon: BarChart3, color: 'from-gray-500 to-gray-600' },
    ...
    { id: 'notifications', label: 'Notifications', icon: Bell, color: 'from-gray-500 to-rose-600' },
    { id: 'account', label: 'Account', icon: Settings, color: 'from-indigo-500 to-gray-600' }
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                <div className="p-3 bg-gradient-to-r from-gray-600 to-gray-600 rounded-xl shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Blogly Platform Management</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                <div className="bg-gradient-to-br from-gray-500 to-gray-600 rounded-2xl p-6 text-white shadow-xl transform hover:scale-105 transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-gray-100 text-sm font-medium">Total Users</p>
                  ...
                  <div className="flex items-center mt-4">
                    ...
                    <span className="text-sm text-gray-100 ml-2">Active platform users</span>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-500 to-gray-600 rounded-2xl p-6 text-white shadow-xl transform hover:scale-105 transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-gray-100 text-sm font-medium">Total Likes</p>
                  ...
                  <div className="flex items-center mt-4">
                    ...
                    <span className="text-sm text-gray-100 ml-2">User engagement</span>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-500 to-gray-600 rounded-2xl p-6 text-white shadow-xl transform hover:scale-105 transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-gray-100 text-sm font-medium">Total Comments</p>
                ...
                <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-xl border border-white/20">
                  ...
                  <div className="flex items-end space-x-2 h-32">
                    {generateDailyPostsData().map((value, index) => (
                      <div key={index} className="flex-1 bg-gradient-to-t from-gray-500 to-gray-600 rounded-t-lg shadow-lg" style={{ height: `${Math.max((value / Math.max(...generateDailyPostsData(), 1)) * 100, 10)}%` }}>
                      ...
                      <tbody className="divide-y divide-gray-100">
                        {filteredBlogs.map((blog) => (
                          <tr key={blog.id} className="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className="px-3 py-1 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-full text-sm font-medium">
                                {blog.category}
                              </span>
                            </td>
          ...
          {activeTab === 'notifications' && (
            <div className="p-8">
              <div className="flex items-center space-x-3 mb-8">
                <div className="p-3 bg-gradient-to-r from-gray-500 to-rose-600 rounded-xl">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent bg-white/50 backdrop-blur-sm"
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-gray-50 to-rose-50 rounded-xl border border-gray-200">
                      <input
                        type="checkbox"
                    ...
                    <Button
                      ...
                      className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-gray-500 to-rose-600 hover:from-gray-600 hover:to-rose-700 shadow-lg py-3 rounded-xl"
          ...
          {activeTab === 'account' && (
            <div className="p-8">
              <div className="flex items-center space-x-3 mb-8">
                <div className="p-3 bg-gradient-to-r from-indigo-500 to-gray-600 rounded-xl">
              ...
              <div className="max-w-2xl">
                <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 shadow-xl border border-white/20">
                  <div className="flex items-center space-x-4 mb-8">
                    <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-gray-600 rounded-full flex items-center justify-center text-white text-xl font-bold">
                      SA
                    </div>
                    <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <Button className="w-full bg-gradient-to-r from-indigo-500 to-gray-600 hover:from-indigo-600 hover:to-gray-700 shadow-lg py-3 rounded-xl">
                      Update Password
                    </Button>
