                ...
                <div>
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 bg-white text-left flex items-center justify-between"
                    >
