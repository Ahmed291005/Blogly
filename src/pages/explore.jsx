...
const Explore = () => {
  ...
  const handleLike = async (blogId) => {
    ...
    // Send API request to update likes in 
    try {
  ...
  const getCategoryColor = (category) => {
    const colors = {
      ...
      'Programming': 'from-indigo-500 to-gray-600',
      ...
      'News & Trends': 'from-red-500 to-gray-600',
      'Productivity': 'from-emerald-500 to-green-600',
      'AI & Machine Learning': 'from-violet-500 to-gray-600',
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-gradient-to-r from-gray-600 to-gray-600 rounded-lg flex items-center justify-center">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Link to="/explore" className="text-gray-600 font-semibold border-b-2 border-gray-600 pb-1">Explore</Link>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button className="bg-gradient-to-r from-gray-600 to-gray-600 hover:from-gray-700 hover:to-gray-700" asChild>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent bg-white/50 backdrop-blur-sm"
              />
            </div>
          ...
          <div className="max-w-2xl mx-auto space-y-6">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        >
                          {isBookmarked ? (
                            <Bookmark className="h-4 w-4 text-gray-600 fill-current" />
                          ) : (
                    ...
                    <div className="mb-4">
                      ...
                      <button
                        ...
                        className="text-gray-600 hover:text-gray-700 text-sm font-medium mt-2"
                      >
            ...
            {!hasMoreBlogs && displayedBlogs.length > 0 && (
              <div className="text-center py-8">
                <div className="w-16 h-16 bg-gradient-to-r from-gray-100 to-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
